main.append(
    ...
    Object.assign(
        document.createElement('section'),
        {
            ...
            <div class="content">
                <div class="section-03-top container" id="section03Top">
                ...
                fetch('./content.json').then(res=>res.json()).then(data=>{
                    ...
                    item.forEach(item=>{
                        ...
                        <div class="card">
                            ...
                            <rect width="25" height="25" rx="12.5" fill="#485265" />
                            <path d="M11.2329 6.47012C11.1105 6.6111 11.0417 6.80229 11.0417 7.00163C11.0417 7.20098 11.1105 7.39217 11.2329 7.53315L14.4654 11.2545L11.2329 14.9759C11.1139 15.1177 11.0481 15.3076 11.0496 15.5047C11.0511 15.7019 11.1198 15.8904 11.2408 16.0298C11.3619 16.1692 11.5257 16.2483 11.6969 16.25C11.8682 16.2517 12.0331 16.1759 12.1563 16.039L15.8505 11.7861C15.9729 11.6451 16.0417 11.4539 16.0417 11.2545C16.0417 11.0552 15.9729 10.864 15.8505 10.723L12.1563 6.47012C12.0338 6.32918 11.8677 6.25 11.6946 6.25C11.5214 6.25 11.3553 6.32918 11.2329 6.47012Z" fill="white" />
                            </svg>
                        </div>
                        `
                    })
